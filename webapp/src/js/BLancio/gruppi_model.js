...
export class Gruppi_Model{
    ...
    // fields
    _urlList   = '/webapi/blancio.asmx/Gruppi_Elenco';
    _urlDetail = '/webapi/blancio.asmx/Gruppo_Dettaglio_GET';
    _urlSet    = '/webapi/blancio.asmx/Gruppo_Dettaglio_SET';
    _urlDelete = '/webapi/blancio.asmx/Gruppo_Dettaglio_DEL';
    _username  = '';
    _password  = '';
    _modelBase = null;
